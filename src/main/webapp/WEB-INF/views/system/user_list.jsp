    ...
    layui.config({
        ...
        table.render({
            ...
            cols: [[
                ...
                {field:'isAdmin', title: '是否是管理员',align:'center',templet: '#isAdmin'},
        ...
        $(".userAdd_btn").click(function(){
            ...
            common.cmsLayOpen('新增用户',url,'700px','500px');
        });
...
<script type="text/html" id="isAdmin">
    ...
    {{# if(d.isAdmin == 0){ }}
    <span style="color:#5FB878;font-weight:bold"> 否</span>
    {{# } else if(d.isAdmin == 1){ }}
    <span style="color:#FF5722;font-weight:bold"> 是</span>

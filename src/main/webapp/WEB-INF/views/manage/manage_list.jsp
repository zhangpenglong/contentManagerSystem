        ...
        <div class="layui-tab">
            <blockquote class="layui-elem-quote mylog-info-tit">
                <div class="layui-inline">
                    <form class="layui-form" id="userSearchForm">
                        ...
                        <div class="layui-input-inline" style="width:145px;">
                            ...
                            <input type="text" name="name" value="" placeholder="请输入姓名" class="layui-input search_input">
                        </div>
                            ...
                            <div class="layui-input-inline" style="width:145px;">
                                <input type="text" name="phone" value="" placeholder="请输入手机号" class="layui-input search_input">
                            </div>
                ...
                <shiro:hasPermission name="0rbT8t2P">
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-normal memberAdd_btn"> <i class="layui-icon larry-icon larry-xinzeng1"></i>新增管家</a>
                    </div>
                </shiro:hasPermission>
            ...
            <div class="layui-tab-item layui-show " style="padding: 10px 15px;">
                <table id="manageTableList"  lay-filter="userTableId" ></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.config({
        ...
        /**用户表格加载*/
        table.render({
            elem: '#manageTableList',
            url: '${ctx}/manage/ajax_manage_list.do',
            id:'manageTableId',
            method: 'post',
            height:'full-140',
            skin:'row',
            ...
            cols: [[
                ...
                {field:'adddree', title: '地址',align:'center'},
        ...
        $(".memberAdd_btn").click(function(){
            var url = "${ctx}/manage/manage_add.do";
            common.cmsLayOpen('新增',url,'700px','500px');
        });
        ...
        table.on('tool(userTableId)', function(obj){
            ...
            if(layEvent === 'member_edit') {
                var id = data.id;
                var url =  "${ctx}/manage/manage_update.do?id="+id;

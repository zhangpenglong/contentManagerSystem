    ...
    <div class="layui-layout layui-layout-admin ">
        ...
        <div class="layui-header header header-menu ">
            <div class="layui-main ">
                <img src="${ctx}/static/img/logo.png" style="width: 60px;height: 50px;position: absolute;left: 5px;right: 10px;top: 7px;">
                <a href="#" class="logo">惠享福会员管理系统</a>
                <!-- 左侧导航收缩开关 -->
        ...
        <div class="layui-footer footer layui-larry-foot">
            ...
            <div class="layui-main">
                <p>Copyright 2018 © huixiangfu.com</p>
            </div>
        </div>
    </div>

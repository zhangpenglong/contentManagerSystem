...
<body>
	<div class="form">
		<form class="layui-form" target="_parent" id="balanceLogsAddForm" action="${request.getContextPath()}/balanceLogs/balanceLogs/saveBalanceLogs" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top:20px;" class="boxTable boxmar">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline" >
                                <input type="text" id="memberId" name="memberId" lay-verify="required" placeholder="请填写会员Id" autocomplete="off" maxlength="20" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">短信Id：</label>
                            <div class="layui-input-inline" >
                                <input type="text" id="msgId" name="msgId" lay-verify="required" placeholder="请填写短信Id" autocomplete="off" maxlength="20" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">操作类型，1.扣费，0充值：</label>
                            <div class="layui-input-inline"  >
                                <input type="text" id="logsType" name="logsType"  autocomplete="off" maxlength="20" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">金额：</label>
                            <div class="layui-input-inline"  >
                                <input type="text" id="balance" name="balance"  autocomplete="off" maxlength="20" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">操作后的余额：</label>
                            <div class="layui-input-inline"  >
                                <input type="text" id="afterBalance" name="afterBalance"  autocomplete="off" maxlength="20" class="layui-input">
                            </div>
                        </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"></label>
                        <div class="layui-input-inline">
                            <button class="layui-btn" lay-submit="" lay-filter="balanceLogsadd">立即提交</button>
...
layui.use(['form','layer','laydate'], function() {
    ...
    //时间空间
        laydate.render({
            ...
            //监听提交
            form.on('submit(balanceLogsadd)', function(data){
                //提交的信息的JSON预览，如需要，请放开注释
                /* layer.alert(JSON.stringify(data.field), {
                      title: '最终的提交信息' // 相当于before
                  })*/
                ajaxSubmit('${request.getContextPath()}/balanceLogs/balanceLogs/saveBalanceLogs',data.field,'post');
                return false;
            });
        });
	</script>

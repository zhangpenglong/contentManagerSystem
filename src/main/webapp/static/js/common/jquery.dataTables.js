...
(/** @lends <global> */function($, window, document, undefined) {
    ...
    var DataTable = function( oInit )
    {
        ...
        function _fnBuildHead( oSettings )
        {
			...
			/* 添加自定义列样式 */
            $(oSettings.nTHead).children('tr').attr('class', 'header_title');
        ...
        function _fnAjaxUpdateDraw ( oSettings, json )
        {
            ...
            oSettings._iRecordsTotal = parseInt(json.totalCount, 10);
            oSettings._iRecordsDisplay = parseInt(json.totalCount, 10);
        ...
        function _fnLanguageCompat( oLanguage )
        {
            ...
            if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
                oDefaults.sEmptyTable === "<p style='text-align: center'>对不起，没有找到相关数据信息！</p>" )
            {
        ...
        function _fnFeatureHtmlProcessing ( oSettings )
        {
            ...
            nProcessing.innerHTML = "";//oSettings.oLanguage.sProcessing; 数据加载中...
        ...
        return this.each(function() {
            ...
            _fnMap( oSettings, oInit, "pageSize", "_iDisplayLength" );
    ...
    DataTable.defaults = {
        ...
        "oLanguage": {
			 ...
			 *    } );
             */
            "sEmptyTable": "<p style='text-align: center'>对不起，没有找到相关数据信息！</p>",
    ...
    $.extend( DataTable.ext.oStdClasses, {
		...
		/*begin  add by wangyilin */
        "sPageButtonFirst": "paginate_button_first",
        "sPageButtonPrevious": "paginate_button_previous",
        "sPageButtonNext": "paginate_button_next",
        "sPageButtonLast": "paginate_button_last",
        "sPageButtonStaticDisabledFirst": "paginate_button paginate_button_disabled_first",
        "sPageButtonStaticDisabledPrevious": "paginate_button paginate_button_disabled_previous",
        "sPageButtonStaticDisabledNext": "paginate_button paginate_button_disabled_next",
        "sPageButtonStaticDisabledLast": "paginate_button paginate_button_disabled_last",
		/* end added */
    ...
    $.extend( DataTable.ext.oPagination, {
        ...
        "full_numbers": {
            ...
            "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
            {
                ...
                $(nPaging).append(
                    '<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'" title="'+oLang.sFirst+'">首页</a>'+
                    '<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'" title="'+oLang.sPrevious+'">上一页</a>'+
                    '<span></span>'+
                    '<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'" title="'+oLang.sNext+' ">下一页</a>'+
                    '<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'" title="'+oLang.sLast+' ">末页</a>'
                );
                var els = $('a', nPaging);
                var nFirst = els[0],
                    nPrev = els[1],
            ...
            "fnUpdate": function ( oSettings, fnCallbackDraw )
            {
                ...
                for ( i=0, iLen=an.length ; i<iLen ; i++ )
                {
                    ...
                    if(iCurrentPage==1){
                        $(anStatic[0]).removeClass(oClasses.sPageButtonFirst);
                        $(anStatic[0]).addClass(oClasses.sPageButtonStaticDisabledFirst);
                        $(anStatic[1]).removeClass(oClasses.sPageButtonPrevious);
                        $(anStatic[1]).addClass(oClasses.sPageButtonStaticDisabledPrevious);
                    }else{
                        $(anStatic[0]).removeClass(oClasses.sPageButtonStaticDisabledFirst);
                        $(anStatic[0]).addClass(oClasses.sPageButtonFirst);
                        $(anStatic[1]).removeClass(oClasses.sPageButtonStaticDisabledPrevious);
                        $(anStatic[1]).addClass(oClasses.sPageButtonPrevious);
                    }
                    if(iPages===0 || iCurrentPage===iPages || oSettings._iDisplayLength===-1){
                        $(anStatic[2]).removeClass(oClasses.sPageButtonNext);
                        $(anStatic[2]).addClass(oClasses.sPageButtonStaticDisabledNext);
                        $(anStatic[3]).removeClass(oClasses.sPageButtonLast);
                        $(anStatic[3]).addClass(oClasses.sPageButtonStaticDisabledLast);
                    }else{
                        $(anStatic[2]).removeClass(oClasses.sPageButtonStaticDisabledNext);
                        $(anStatic[2]).addClass(oClasses.sPageButtonNext);
                        $(anStatic[3]).removeClass(oClasses.sPageButtonStaticDisabledLast);
                        $(anStatic[3]).addClass(oClasses.sPageButtonLast);
                    }
                }
            }
        }

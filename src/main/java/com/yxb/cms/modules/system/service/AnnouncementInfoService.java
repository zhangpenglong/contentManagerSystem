...
import com.yxb.cms.modules.system.dao.AnnouncementInfoMapper;
import com.yxb.cms.modules.system.dao.AnnouncementInfoUserMapper;
import com.yxb.cms.modules.system.domain.bo.BussinessMsg;
import com.yxb.cms.modules.system.domain.vo.AnnouncementInfo;
import com.yxb.cms.modules.system.domain.vo.AnnouncementInfoUser;
...
public class AnnouncementInfoService {
    ...
    public String selectAnnInfoResultPageList(AnnouncementInfo annInfo) {
        ...
        List<AnnouncementInfo> annList = announcementInfoMapper.selectAnnouncementInfoListBy(annInfo);

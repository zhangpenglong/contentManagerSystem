 ...
 */
package com.yxb.cms.modules.system.controller.system;
...
import com.yxb.cms.old.architect.utils.CommonHelper;
...
import com.yxb.cms.modules.system.service.RoleService;
...
public class UserController extends BasicController {
    ...
    public String toUserListPage(Model model) {
        ...
        List<Dic> dics = manageService.selectDic(user);
    ...
    public String ajaxUserList(User user){
        return userService.selectUserResultPageList(user,getCurrentLoginId(),getCurrentLoginName(),getCurrentUser().getAddress());
    }
     ...
     * @return
     */
    @RequestMapping("/user_pwd.do")
    public String toUserPwd(Model model) {
    ...
    public String ajax_updatePwd(String userPassword){
        Map map = new HashMap();
        map.put("code",0);
        map.put("msg","修改失败");
        User user = getCurrentUser();
        try {
            ...
            userService.saveOrUpdateUser(user,user.getUserLoginName());
            map.put("code",1);
            map.put("msg","");
        } catch (Exception e) {
            e.printStackTrace();

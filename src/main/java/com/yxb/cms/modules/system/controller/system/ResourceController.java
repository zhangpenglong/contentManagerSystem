...
import com.yxb.cms.modules.system.service.ResourceService;
...
public class ResourceController extends BasicController {
    ...
    public String ajaxResMenuTop(){
        ...
        List<ResourceMenuDto> allMenu = userService.getAllMenu(userId, 1);
        if(null != allMenu && !allMenu.isEmpty()){
            return Json.toJson(allMenu, JsonFormat.full());
        }
        return null;
    }
    ...
    public String ajaxResMenuLeft(Integer resParentid){
        return resourceService.selectResLevelListByParentid(resParentid,getCurrentLoginId());
    }

...
import com.yxb.cms.modules.system.dao.ResourceMapper;
...
import com.yxb.cms.old.architect.utils.KeyConfig;
import com.yxb.cms.modules.system.domain.bo.Tree;
import com.yxb.cms.modules.system.domain.dto.ResourceChildrenMenuDto;
import com.yxb.cms.modules.system.domain.dto.ResourceMenuDto;
import com.yxb.cms.modules.system.domain.vo.Resource;
...
public class ResourceService {
    ...
    public String selectResourceResultPageList(Resource resource){
        ...
        List<Resource> resourceList = resourceMapper.selectResourceList(resource);
     ...
     * @return
     */
    public  String selectResLevelListByParentid(Integer resParentid,Integer userId) {

        //二级菜单
        List<Resource> ResLevel2List =resourceMapper.selectResLevelListByParentid(resParentid);
        if(userId != Constants.ADMINID){
            ResLevel2List = userService.get2Menu(userId,ResLevel2List);
        }
        ...
        if(null != ResLevel2List && !ResLevel2List.isEmpty()){
            ...
            for (Resource resource2 : ResLevel2List) {
                ...
                if(userId != Constants.ADMINID){
                    ResLevel3List = userService.get2Menu(userId,ResLevel3List);
                }

...
public class Servlets {
	...
	public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value, Integer maxAge) {
		addCookie(request, response, name, value, maxAge, Constants.COOKIEPATH, Constants.COOKIEDOMAIN, null);
	}
	...
	public static void addCookie(HttpServletRequest request, HttpServletResponse response, String name, String value) {
		addCookie(request, response, name, value, null, Constants.COOKIEPATH, Constants.COOKIEDOMAIN, null);
	}
	...
	public static void removeCookie(HttpServletRequest request, HttpServletResponse response, String name) {
		removeCookie(request, response, name, Constants.COOKIEPATH, Constants.COOKIEDOMAIN);
	}
	...
	public static String getContextFullPath(HttpServletRequest request){
		...
		result.append(request.getScheme()+"://"+request.getServerName());
